package com.daff.favoriteapp.model;
...
import static com.daff.favoriteapp.database.DatabaseConstract.getColumnDouble;
import static com.daff.favoriteapp.database.DatabaseConstract.getColumnInt;
import static com.daff.favoriteapp.database.DatabaseConstract.getColumnString;
...
public class FavoriteResult implements Parcelable {
    ...
    public FavoriteResult(int id, String overview, String originalTitle, String posterPath, String backdropPath, String releaseDate, double voteAverage) {
        this.id = id;
        this.overview = overview;
        this.originalTitle = originalTitle;
        this.posterPath = posterPath;
    ...
    public FavoriteResult(Cursor cursor) {
        this.id = getColumnInt(cursor, _ID);
        this.originalTitle = getColumnString(cursor, TITLE);
        this.overview = getColumnString(cursor, OVERVIEW);
        this.releaseDate = getColumnString(cursor, REL_DATE);
    ...
    public static final Parcelable.Creator<FavoriteResult> CREATOR = new Parcelable.Creator<FavoriteResult>() {
        @Override
        public FavoriteResult createFromParcel(Parcel source) {
